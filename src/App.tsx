...
const App = () => {
  ...
  // LECTURA EN TIEMPO REAL DESDE FIREBASE (Sincronización total)
  useEffect(() => {
    ...
    <div className="min-h-screen bg-slate-100 font-sans p-6">
      ...
      <div className="max-w-7xl mx-auto mb-8 flex justify-between items-center bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
        <div>
          ...
          <p className="text-slate-500 font-medium">Gestión Documental y Búsqueda Avanzada</p>
        </div>
        <div className="flex gap-3">
          ...
          <button onClick={exportBackup} className="px-4 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold flex items-center gap-2 border border-slate-300">
            <Download size={18} /> Exportar
          </button>
          <label className="px-4 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold flex items-center gap-2 border border-slate-300 cursor-pointer">
